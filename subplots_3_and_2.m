function varargout = subplots_3_and_2(varargin)
% SUBPLOTS_3_AND_2 MATLAB code for subplots_3_and_2.fig
%      SUBPLOTS_3_AND_2, by itself, creates a new SUBPLOTS_3_AND_2 or raises the existing
%      singleton*.
%
%      H = SUBPLOTS_3_AND_2 returns the handle to a new SUBPLOTS_3_AND_2 or the handle to
%      the existing singleton*.
%
%      SUBPLOTS_3_AND_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SUBPLOTS_3_AND_2.M with the given input arguments.
%
%      SUBPLOTS_3_AND_2('Property','Value',...) creates a new SUBPLOTS_3_AND_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before subplots_3_and_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to subplots_3_and_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help subplots_3_and_2

% Last Modified by GUIDE v2.5 16-Aug-2019 16:30:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @subplots_3_and_2_OpeningFcn, ...
                   'gui_OutputFcn',  @subplots_3_and_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before subplots_3_and_2 is made visible.
function subplots_3_and_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to subplots_3_and_2 (see VARARGIN)

% Choose default command line output for subplots_3_and_2
...
% UIWAIT makes subplots_3_and_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = subplots_3_and_2_OutputFcn(hObject, eventdata, handles) 
