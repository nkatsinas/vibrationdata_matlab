function varargout = SEA_one_cylindrical_shell(varargin)
% SEA_ONE_CYLINDRICAL_SHELL MATLAB code for SEA_one_cylindrical_shell.fig
%      SEA_ONE_CYLINDRICAL_SHELL, by itself, creates a new SEA_ONE_CYLINDRICAL_SHELL or raises the existing
%      singleton*.
%
%      H = SEA_ONE_CYLINDRICAL_SHELL returns the handle to a new SEA_ONE_CYLINDRICAL_SHELL or the handle to
%      the existing singleton*.
%
%      SEA_ONE_CYLINDRICAL_SHELL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_ONE_CYLINDRICAL_SHELL.M with the given input arguments.
%
%      SEA_ONE_CYLINDRICAL_SHELL('Property','Value',...) creates a new SEA_ONE_CYLINDRICAL_SHELL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_one_cylindrical_shell_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_one_cylindrical_shell_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_one_cylindrical_shell

% Last Modified by GUIDE v2.5 21-Sep-2018 14:15:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_one_cylindrical_shell_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_one_cylindrical_shell_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_one_cylindrical_shell is made visible.
function SEA_one_cylindrical_shell_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_one_cylindrical_shell (see VARARGIN)

% Choose default command line output for SEA_one_cylindrical_shell
...
% UIWAIT makes SEA_one_cylindrical_shell wait for user response (see UIRESUME)
...
function varargout = SEA_one_cylindrical_shell_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_one_cylindrical_shell);
...
[fig_num]=plot_loglin_function_md(fig_num,x_label,y_label,t_string,rrr,fstart,fend,md);           
