...
try
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M7 AC-6319 Fwd Fin Box Ascent, Normalized';
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M8 AC-6319 Fwd Fin Box Ascent, Normalized';
        [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M9 AC-6319 Fwd Fin Box Ascent, Normalized';
        [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS P7 AC-6319 Fwd Fin Box Ascent, Normalized';
        [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  ttt='NS P8 AC-6319 Fwd Fin Box Ascent, Normalized';
      [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M4 AC-6310 Fwd Fin Box Ascent, Normalized';
     [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M5 AC-6310 Fwd Fin Box Ascent, Normalized';
        [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M5 AC-6322 Fwd Fin Ring Frame Valve Base Ascent, Normalized';
       [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M6 AC-6322 Fwd Fin Ring Frame Valve Base Ascent, Normalized';
       [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M4 AC-6320 Fwd Ring Frame OML Ascent, Normalized';
        [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M5 AC-6320 Fwd Ring Frame OML Ascent, Normalized';
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
