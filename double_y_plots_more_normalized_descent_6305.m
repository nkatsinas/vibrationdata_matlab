...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M4 AC-6305 Aft Equipment Bay Descent, Normalized';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M5 AC-6305 Aft Equipment Bay Descent, Normalized';
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M6 AC-6305 Aft Equipment Bay Descent, Normalized';
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M7 AC-6305 Aft Equipment Bay Descent, Normalized';
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ttt='NS M8 AC-6305 Aft Equipment Bay Descent, Normalized';
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
