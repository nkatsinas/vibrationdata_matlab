function varargout = fds_subplots_2x2_two_curves(varargin)
% FDS_SUBPLOTS_2X2_TWO_CURVES MATLAB code for fds_subplots_2x2_two_curves.fig
%      FDS_SUBPLOTS_2X2_TWO_CURVES, by itself, creates a new FDS_SUBPLOTS_2X2_TWO_CURVES or raises the existing
%      singleton*.
%
%      H = FDS_SUBPLOTS_2X2_TWO_CURVES returns the handle to a new FDS_SUBPLOTS_2X2_TWO_CURVES or the handle to
%      the existing singleton*.
%
%      FDS_SUBPLOTS_2X2_TWO_CURVES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FDS_SUBPLOTS_2X2_TWO_CURVES.M with the given input arguments.
%
%      FDS_SUBPLOTS_2X2_TWO_CURVES('Property','Value',...) creates a new FDS_SUBPLOTS_2X2_TWO_CURVES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fds_subplots_2x2_two_curves_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fds_subplots_2x2_two_curves_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fds_subplots_2x2_two_curves

% Last Modified by GUIDE v2.5 09-Apr-2020 18:51:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fds_subplots_2x2_two_curves_OpeningFcn, ...
                   'gui_OutputFcn',  @fds_subplots_2x2_two_curves_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fds_subplots_2x2_two_curves is made visible.
function fds_subplots_2x2_two_curves_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fds_subplots_2x2_two_curves (see VARARGIN)

% Choose default command line output for fds_subplots_2x2_two_curves
...
% UIWAIT makes fds_subplots_2x2_two_curves wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fds_subplots_2x2_two_curves_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
delete(fds_subplots_2x2_two_curves);
