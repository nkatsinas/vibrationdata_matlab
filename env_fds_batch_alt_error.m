%
%  env_fds_batch_alt_error.m  ver 1.4  by Tom Irvine
%
function[fds_samfine,error]=env_fds_batch_alt_error(interp_psdin,nnn,fn,dam,bex,T,iu,nmetric,fds_ref,n_ref)
...
for i=1:n
    for k=1:n_ref
        error=error+abs(10*log10(fds_ref(k,i)/fds_samfine(k,i)));        
    end
end    
