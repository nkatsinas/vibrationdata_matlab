function varargout = vibrationdata_wavelet_decomposition_sdof_response(varargin)
% VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE MATLAB code for vibrationdata_wavelet_decomposition_sdof_response.fig
%      VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE, by itself, creates a new VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE returns the handle to a new VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE.M with the given input arguments.
%
%      VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE('Property','Value',...) creates a new VIBRATIONDATA_WAVELET_DECOMPOSITION_SDOF_RESPONSE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_wavelet_decomposition_sdof_response_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_wavelet_decomposition_sdof_response_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_wavelet_decomposition_sdof_response

% Last Modified by GUIDE v2.5 08-Nov-2021 14:13:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_wavelet_decomposition_sdof_response_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_wavelet_decomposition_sdof_response_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_wavelet_decomposition_sdof_response is made visible.
function vibrationdata_wavelet_decomposition_sdof_response_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_wavelet_decomposition_sdof_response (see VARARGIN)

% Choose default command line output for vibrationdata_wavelet_decomposition_sdof_response
...
% UIWAIT makes vibrationdata_wavelet_decomposition_sdof_response wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_wavelet_decomposition_sdof_response_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_wavelet_decomposition_sdof_response);
...
LF=get(handles.listbox_freq,'Value');
...
[acceleration,velocity,displacement,wavelet_table]=...
    vibrationdata_wavelet_decomposition_engine_ls_sdof(tr,store_recon,dt,first,...
...
residual(:,1)=THM(:,1);
residual(:,2)=THM(:,2)-acceleration(:,2);
...
prefix=strtrim(get(handles.edit_input_array,'String'));
