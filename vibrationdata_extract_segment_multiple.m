function varargout = vibrationdata_extract_segment_multiple(varargin)
% VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE MATLAB code for vibrationdata_extract_segment_multiple.fig
%      VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE, by itself, creates a new VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE returns the handle to a new VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE.M with the given input arguments.
%
%      VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE('Property','Value',...) creates a new VIBRATIONDATA_EXTRACT_SEGMENT_MULTIPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_extract_segment_multiple_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_extract_segment_multiple_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_extract_segment_multiple

% Last Modified by GUIDE v2.5 23-Jul-2019 16:50:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_extract_segment_multiple_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_extract_segment_multiple_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_extract_segment_multiple is made visible.
function vibrationdata_extract_segment_multiple_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_extract_segment_multiple (see VARARGIN)

% Choose default command line output for vibrationdata_extract_segment_multiple
...
% UIWAIT makes vibrationdata_extract_segment_multiple wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_extract_segment_multiple_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_extract_segment_multiple);
...
set(handles.listbox_num,'Visible','on');
