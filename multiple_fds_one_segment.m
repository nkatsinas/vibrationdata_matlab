function varargout = multiple_fds_one_segment(varargin)
% MULTIPLE_FDS_ONE_SEGMENT MATLAB code for multiple_fds_one_segment.fig
%      MULTIPLE_FDS_ONE_SEGMENT, by itself, creates a new MULTIPLE_FDS_ONE_SEGMENT or raises the existing
%      singleton*.
%
%      H = MULTIPLE_FDS_ONE_SEGMENT returns the handle to a new MULTIPLE_FDS_ONE_SEGMENT or the handle to
%      the existing singleton*.
%
%      MULTIPLE_FDS_ONE_SEGMENT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MULTIPLE_FDS_ONE_SEGMENT.M with the given input arguments.
%
%      MULTIPLE_FDS_ONE_SEGMENT('Property','Value',...) creates a new MULTIPLE_FDS_ONE_SEGMENT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before multiple_fds_one_segment_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to multiple_fds_one_segment_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help multiple_fds_one_segment

% Last Modified by GUIDE v2.5 20-Jul-2020 15:53:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @multiple_fds_one_segment_OpeningFcn, ...
                   'gui_OutputFcn',  @multiple_fds_one_segment_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before multiple_fds_one_segment is made visible.
function multiple_fds_one_segment_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to multiple_fds_one_segment (see VARARGIN)

% Choose default command line output for multiple_fds_one_segment
...
cn={'Time History','Legend','Start Time','End Time'};
set(handles.uitable_data,'ColumnName',cn);
...
% UIWAIT makes multiple_fds_one_segment wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = multiple_fds_one_segment_OutputFcn(hObject, eventdata, handles) 
...
delete(multiple_fds_one_segment);
...
%
    ...
    [fds_th]=fds_engine(fds_th,yy,nf,nQ,Q,nbex,bex,fn,dt);
