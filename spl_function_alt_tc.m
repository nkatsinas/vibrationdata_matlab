%
% spl_function_alt_tc.m  ver 1.2  by Tom Irvine
%
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
function[spl,oaspl,iflag]=spl_function_alt_tc(mr,window,t1,t2,THM,ref)
...
[spl,oaspl]=spl_core_alt(mmm,NW,mr,window,amp,df,ref);
