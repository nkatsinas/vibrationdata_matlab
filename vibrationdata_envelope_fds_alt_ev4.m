function varargout = vibrationdata_envelope_fds_alt_ev4(varargin)
% VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4 MATLAB code for vibrationdata_envelope_fds_alt_ev4.fig
%      VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4, by itself, creates a new VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4 or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4 returns the handle to a new VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4 or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4.M with the given input arguments.
%
%      VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4('Property','Value',...) creates a new VIBRATIONDATA_ENVELOPE_FDS_ALT_EV4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_envelope_fds_alt_ev4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_envelope_fds_alt_ev4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_envelope_fds_alt_ev4

% Last Modified by GUIDE v2.5 29-Aug-2019 08:28:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_envelope_fds_alt_ev4_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_envelope_fds_alt_ev4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_envelope_fds_alt_ev4 is made visible.
function vibrationdata_envelope_fds_alt_ev4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_envelope_fds_alt_ev4 (see VARARGIN)

% Choose default command line output for vibrationdata_envelope_fds_alt_ev4
...
% UIWAIT makes vibrationdata_envelope_fds_alt_ev4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_envelope_fds_alt_ev4_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_envelope_fds_alt_ev4);
...
ss=get(handles.edit_output_array,'String');
...
set(handles.edit_output_array,'String',ss);

%%

ss=get(handles.edit_save_name,'String');
...
set(handles.edit_save_name,'String',ss);
