%
%  plot_frf_md_two_two.m  ver 1.2  by Tom Irvine
%
function[fig_num]=plot_frf_md_two_two(fig_num,freq,frf,ofrf,fmin,fmax,t_string,y_label,md)
...
out1=sprintf('%s Response 1',t_string);
title(out1);
grid on;
ylabel('Phase (deg)');
ylim([-180,180]);
...
out1=sprintf('%s Response 2',t_string);
title(out1);
grid on;
ylabel('Phase (deg)');
ylim([-180,180]);
