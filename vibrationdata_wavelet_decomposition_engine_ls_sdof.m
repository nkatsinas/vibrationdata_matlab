%
%   vibrationdata_wavelet_decomposition_engine_ls_sdof.m  ver 1.0  by Tom Irvine
%
%
function[acceleration,velocity,displacement,wavelet_table]=...
  vibrationdata_wavelet_decomposition_engine_ls_sdof(t,accel,dt,first,...
...
%
    ...
    while(1)
        ...
        try
            ...
            ijk=ie;
            [ax1r,ax2r,ax3r,ax4r,ar]=decomposition_wgen_ls_sdof(t(ia:ib),residual(ia:ib),minw,maxw,start_time,ffmin,ffmax,ijk);
        catch
            size(t)
            size(residual)
            size(r1)
