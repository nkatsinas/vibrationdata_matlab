...
%  beam_FEA_base_arbitrary_BC2_HS.m  ver 1.1  by Tom Irvine

function[accel,rel_disp,stress,fig_num]=...
               beam_FEA_base_arbitrary_BC2_HS(ndof,acc,ddd,dt,fn,iu,nde,dx,nt,tpi,cna,E,fig_num,THM,mid_dof)
...
disp(' ');
if(iu==1)
    disp('  Beam Mid Span Pseudo Velocity (in/sec) from Fundamental Mode');
    sss=386;
else
    disp('  Beam Mid Span Pseudo Velocity (m/sec) from Fundamental Mode');
    sss=1;
end
