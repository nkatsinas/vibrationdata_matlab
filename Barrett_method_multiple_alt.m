function varargout = Barrett_method_multiple_alt(varargin)
% BARRETT_METHOD_MULTIPLE_ALT MATLAB code for Barrett_method_multiple_alt.fig
%      BARRETT_METHOD_MULTIPLE_ALT, by itself, creates a new BARRETT_METHOD_MULTIPLE_ALT or raises the existing
%      singleton*.
%
%      H = BARRETT_METHOD_MULTIPLE_ALT returns the handle to a new BARRETT_METHOD_MULTIPLE_ALT or the handle to
%      the existing singleton*.
%
%      BARRETT_METHOD_MULTIPLE_ALT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BARRETT_METHOD_MULTIPLE_ALT.M with the given input arguments.
%
%      BARRETT_METHOD_MULTIPLE_ALT('Property','Value',...) creates a new BARRETT_METHOD_MULTIPLE_ALT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Barrett_method_multiple_alt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Barrett_method_multiple_alt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Barrett_method_multiple_alt

% Last Modified by GUIDE v2.5 14-Jun-2019 16:15:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Barrett_method_multiple_alt_OpeningFcn, ...
                   'gui_OutputFcn',  @Barrett_method_multiple_alt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Barrett_method_multiple_alt is made visible.
function Barrett_method_multiple_alt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Barrett_method_multiple_alt (see VARARGIN)

% Choose default command line output for Barrett_method_multiple_alt
...
% UIWAIT makes Barrett_method_multiple_alt wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Barrett_method_multiple_alt_OutputFcn(hObject, eventdata, handles) 
...
delete(Barrett_method_multiple_alt);
...
try
    FS3=strtrim(get(handles.edit_ref_psd,'String'));
...
%% 
    ...
    if(ncols==1)
        ...
        oadb1=oadb_input(1);         
        [oadb2]=oaspl_function(SPL_new(:,1));
        ...
        [fig_num]=spl_plot_two_title(fig_num,n_type,SPL_new(:,1),SPL_new(:,2),SPL_ref(:,1),SPL_ref(:,2),leg1,leg2,tstring);           
