%
%  plot_PSD_function_markers.m  ver 2,0 by Tom Irvine
%
function[fig_num,h2]=plot_PSD_function_markers(fig_num,x_label,y_label,t_string,ppp,qqq,fmin,fmax)
%
f=ppp(:,1);
a=ppp(:,2);
ff=qqq(:,1);
...
set(gca,'MinorGridLineStyle',':','GridLineStyle',':','XScale','log',...
                     'YScale','log','XminorTick','off','YminorTick','off');
%
axis([0.99*fmin,1.01*fmax,ymin,ymax]);

n=length(ff);
n
for i=1:n
    plot([ff(i) ff(i)],[ymin aa(i)],'r--');
end
