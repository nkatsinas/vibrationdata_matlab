%
%  plot_loglog_multiple_function_none.m  ver 1.2   By Tom Irvine
%
function[fig_num]=plot_loglog_multiple_function_none(fig_num,x_label,y_label,t_string,ppp,leg,fmin,fmax)
%
f=ppp(:,1);
