...
fig_num=200;
    ...
    p4= M1_AC_6309_RMS;
    ttt='NS M1 AC-6309 Fwd Deflector Shoulder IML, Descent Supersonic';     
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);
    
     p4= M1_AC_6310_RMS;
    ttt='NS M1 AC-6310 Fwd Fin Box, Descent Supersonic';     
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);   
    
     p4= M1_AC_6319_RMS;
    ttt='NS M1 AC-6319 Ring Fin IML, Descent Supersonic';     
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);   
    
      p4= M1_AC_6320_RMS;
    ttt='NS M1 AC-6320 Ring Fin OML, Descent Supersonic';     
    [fig_num]=plot_core(fig_num,p1,p2,p3,p4,ttt,t1,t2);  
