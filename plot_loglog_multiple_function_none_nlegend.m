%
%  plot_loglog_multiple_function_none_nlegend.m  ver 1.2   By Tom Irvine
%
function[fig_num]=plot_loglog_multiple_function_none_nlegend(fig_num,x_label,y_label,t_string,ppp,leg,fmin,fmax,nlegend)
%
f=ppp(:,1);
