function varargout = triple_y_subplot_1x2(varargin)
% TRIPLE_Y_SUBPLOT_1X2 MATLAB code for triple_y_subplot_1x2.fig
%      TRIPLE_Y_SUBPLOT_1X2, by itself, creates a new TRIPLE_Y_SUBPLOT_1X2 or raises the existing
%      singleton*.
%
%      H = TRIPLE_Y_SUBPLOT_1X2 returns the handle to a new TRIPLE_Y_SUBPLOT_1X2 or the handle to
%      the existing singleton*.
%
%      TRIPLE_Y_SUBPLOT_1X2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRIPLE_Y_SUBPLOT_1X2.M with the given input arguments.
%
%      TRIPLE_Y_SUBPLOT_1X2('Property','Value',...) creates a new TRIPLE_Y_SUBPLOT_1X2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before triple_y_subplot_1x2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to triple_y_subplot_1x2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help triple_y_subplot_1x2

% Last Modified by GUIDE v2.5 28-Oct-2019 09:00:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @triple_y_subplot_1x2_OpeningFcn, ...
                   'gui_OutputFcn',  @triple_y_subplot_1x2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before triple_y_subplot_1x2 is made visible.
function triple_y_subplot_1x2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to triple_y_subplot_1x2 (see VARARGIN)

% Choose default command line output for triple_y_subplot_1x2
...
% UIWAIT makes triple_y_subplot_1x2 wait for user response (see UIRESUME)
...
function varargout = triple_y_subplot_1x2_OutputFcn(hObject, eventdata, handles) 
