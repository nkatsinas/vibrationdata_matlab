function varargout = liftoff_load(varargin)
% LIFTOFF_LOAD MATLAB code for liftoff_load.fig
%      LIFTOFF_LOAD, by itself, creates a new LIFTOFF_LOAD or raises the existing
%      singleton*.
%
%      H = LIFTOFF_LOAD returns the handle to a new LIFTOFF_LOAD or the handle to
%      the existing singleton*.
%
%      LIFTOFF_LOAD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LIFTOFF_LOAD.M with the given input arguments.
%
%      LIFTOFF_LOAD('Property','Value',...) creates a new LIFTOFF_LOAD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before liftoff_load_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to liftoff_load_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help liftoff_load

% Last Modified by GUIDE v2.5 08-Nov-2019 10:45:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @liftoff_load_OpeningFcn, ...
                   'gui_OutputFcn',  @liftoff_load_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before liftoff_load is made visible.
function liftoff_load_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to liftoff_load (see VARARGIN)

% Choose default command line output for liftoff_load
...
% UIWAIT makes liftoff_load wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = liftoff_load_OutputFcn(hObject, eventdata, handles) 
