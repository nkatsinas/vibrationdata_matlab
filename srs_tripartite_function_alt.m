%
%   srs_tripartite_function_alt.m   ver 2.5   by Tom Irvine
%
function[fig_num,hp]=srs_tripartite_function_alt(iunit,fig_num,freq,PV,arows,leg,tstring)
%
...
%
        for i=1:num
            plot(freq(1:arows(i),i),PV(1:arows(i),i),'LineWidth',2,'Color',cmap(i,:),'DisplayName',leg{i});
        end    
