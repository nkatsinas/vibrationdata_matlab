function varargout = vibrationdata_remove_sine_tones_delay(varargin)
%VIBRATIONDATA_REMOVE_SINE_TONES_DELAY M-file for vibrationdata_remove_sine_tones_delay.fig
%      VIBRATIONDATA_REMOVE_SINE_TONES_DELAY, by itself, creates a new VIBRATIONDATA_REMOVE_SINE_TONES_DELAY or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_REMOVE_SINE_TONES_DELAY returns the handle to a new VIBRATIONDATA_REMOVE_SINE_TONES_DELAY or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_REMOVE_SINE_TONES_DELAY('Property','Value',...) creates a new VIBRATIONDATA_REMOVE_SINE_TONES_DELAY using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to vibrationdata_remove_sine_tones_delay_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      VIBRATIONDATA_REMOVE_SINE_TONES_DELAY('CALLBACK') and VIBRATIONDATA_REMOVE_SINE_TONES_DELAY('CALLBACK',hObject,...) call the
%      local function named CALLBACK in VIBRATIONDATA_REMOVE_SINE_TONES_DELAY.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help vibrationdata_remove_sine_tones_delay

% Last Modified by GUIDE v2.5 30-Sep-2019 12:55:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_remove_sine_tones_delay_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_remove_sine_tones_delay_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_remove_sine_tones_delay is made visible.
function vibrationdata_remove_sine_tones_delay_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for vibrationdata_remove_sine_tones_delay
...
% UIWAIT makes vibrationdata_remove_sine_tones_delay wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_remove_sine_tones_delay_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
delete(vibrationdata_remove_sine_tones_delay);
...
disp('sine_find_function_manual_delay');

[syn,residual,Ar,Br,omeganr,nstartr,nendr]=sine_find_function_manual_delay(dur,a,amp_orig,t,dt,nfr,fl,fu);
...
%
for ie=1:nfr
    out4 = sprintf('  %d  %10.4f  %10.4f  %10.4f %d',ie,x1r(ie),x2r(ie)/tp,x3r(ie),nstartr(ie),nendr(ie));
    disp(out4)      
end    
%
%
