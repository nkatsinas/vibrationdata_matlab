function varargout = SEA_panel_acoustic_response_sandwich(varargin)
% SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH MATLAB code for SEA_panel_acoustic_response_sandwich.fig
%      SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH, by itself, creates a new SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH or raises the existing
%      singleton*.
%
%      H = SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH returns the handle to a new SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH or the handle to
%      the existing singleton*.
%
%      SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH.M with the given input arguments.
%
%      SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH('Property','Value',...) creates a new SEA_PANEL_ACOUSTIC_RESPONSE_SANDWICH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_panel_acoustic_response_sandwich_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_panel_acoustic_response_sandwich_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_panel_acoustic_response_sandwich

% Last Modified by GUIDE v2.5 29-Apr-2016 11:04:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_panel_acoustic_response_sandwich_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_panel_acoustic_response_sandwich_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_panel_acoustic_response_sandwich is made visible.
function SEA_panel_acoustic_response_sandwich_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_panel_acoustic_response_sandwich (see VARARGIN)

% Choose default command line output for SEA_panel_acoustic_response_sandwich
...
% UIWAIT makes SEA_panel_acoustic_response_sandwich wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_panel_acoustic_response_sandwich_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_panel_acoustic_response_sandwich);
