%
%  spl_core.m  ver 1.4  by Tom Irvine
%
...
%      h_choice - 1=Rectangular  2=Hanning   3=Flat Top
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
function[spl,oaspl]=spl_core_alt(mmm,NW,mr_choice,h_choice,amp,df,ref)
%   
...
%
    [~,band_dB]=convert_FFT_to_one_third_rms(freq,fl,fu,full_rms,ref);
