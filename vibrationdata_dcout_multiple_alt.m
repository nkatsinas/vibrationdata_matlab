function varargout = vibrationdata_dcout_multiple_alt(varargin)
% VIBRATIONDATA_DCOUT_MULTIPLE_ALT MATLAB code for vibrationdata_dcout_multiple_alt.fig
%      VIBRATIONDATA_DCOUT_MULTIPLE_ALT, by itself, creates a new VIBRATIONDATA_DCOUT_MULTIPLE_ALT or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_DCOUT_MULTIPLE_ALT returns the handle to a new VIBRATIONDATA_DCOUT_MULTIPLE_ALT or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_DCOUT_MULTIPLE_ALT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_DCOUT_MULTIPLE_ALT.M with the given input arguments.
%
%      VIBRATIONDATA_DCOUT_MULTIPLE_ALT('Property','Value',...) creates a new VIBRATIONDATA_DCOUT_MULTIPLE_ALT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_dcout_multiple_alt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_dcout_multiple_alt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_dcout_multiple_alt

% Last Modified by GUIDE v2.5 17-Jun-2020 17:58:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_dcout_multiple_alt_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_dcout_multiple_alt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_dcout_multiple_alt is made visible.
function vibrationdata_dcout_multiple_alt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_dcout_multiple_alt (see VARARGIN)

% Choose default command line output for vibrationdata_dcout_multiple_alt
...
% UIWAIT makes vibrationdata_dcout_multiple_alt wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_dcout_multiple_alt_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_dcout_multiple_alt);
