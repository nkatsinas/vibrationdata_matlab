%
%  plot_fds_title_function_alt.m  ver 1.2   By Tom Irvine
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
function[fig_num,hp]=plot_fds_title_function_alt(fig_num,x_label,ppp,fmin,fmax,nmetric,Q,bex,FS,iu)
%
f=ppp(:,1);
a=ppp(:,2);
%
