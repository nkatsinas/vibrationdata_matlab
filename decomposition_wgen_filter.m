%
%  decomposition_wgen_filter.m   version 3.3   by Tom Irvine
%
function[x1r,x2r,x3r,x4r]=...
decomposition_wgen_filter(t,residual,nt,start_time,minw,maxw,fc,sd,duration,num2)
%
...
%
out1=sprintf(' ave=%12.4g  sd=%12.4g  nt=%d',ave,sdv,nt);
disp(out1);
%
am=2.*sdv;
%
