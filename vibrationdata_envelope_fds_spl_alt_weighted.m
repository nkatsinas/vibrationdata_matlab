function varargout = vibrationdata_envelope_fds_spl_alt_weighted(varargin)
% VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED MATLAB code for vibrationdata_envelope_fds_spl_alt_weighted.fig
%      VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED, by itself, creates a new VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED returns the handle to a new VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED.M with the given input arguments.
%
%      VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED('Property','Value',...) creates a new VIBRATIONDATA_ENVELOPE_FDS_SPL_ALT_WEIGHTED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_envelope_fds_spl_alt_weighted_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_envelope_fds_spl_alt_weighted_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_envelope_fds_spl_alt_weighted

% Last Modified by GUIDE v2.5 26-Sep-2019 18:35:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_envelope_fds_spl_alt_weighted_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_envelope_fds_spl_alt_weighted_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_envelope_fds_spl_alt_weighted is made visible.
function vibrationdata_envelope_fds_spl_alt_weighted_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_envelope_fds_spl_alt_weighted (see VARARGIN)

% Choose default command line output for vibrationdata_envelope_fds_spl_alt_weighted
...
% UIWAIT makes vibrationdata_envelope_fds_spl_alt_weighted wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_envelope_fds_spl_alt_weighted_OutputFcn(hObject, eventdata, handles) 
...
%      scale the psd
    ...
    if(istrat<=3)
        [scale,error,error_max]=env_compare_alt_error_spl_weighted(n_ref,fds_ref,fds_samfine,bex);
    end
%       
