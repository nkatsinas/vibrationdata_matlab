function varargout = two_dof_system_a(varargin)
% TWO_DOF_SYSTEM_A MATLAB code for two_dof_system_a.fig
%      TWO_DOF_SYSTEM_A, by itself, creates a new TWO_DOF_SYSTEM_A or raises the existing
%      singleton*.
%
%      H = TWO_DOF_SYSTEM_A returns the handle to a new TWO_DOF_SYSTEM_A or the handle to
%      the existing singleton*.
%
%      TWO_DOF_SYSTEM_A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TWO_DOF_SYSTEM_A.M with the given input arguments.
%
%      TWO_DOF_SYSTEM_A('Property','Value',...) creates a new TWO_DOF_SYSTEM_A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before two_dof_system_a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to two_dof_system_a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help two_dof_system_a

% Last Modified by GUIDE v2.5 11-Oct-2016 13:52:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @two_dof_system_a_OpeningFcn, ...
                   'gui_OutputFcn',  @two_dof_system_a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before two_dof_system_a is made visible.
function two_dof_system_a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to two_dof_system_a (see VARARGIN)

% Choose default command line output for two_dof_system_a
...
% UIWAIT makes two_dof_system_a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = two_dof_system_a_OutputFcn(hObject, eventdata, handles) 
