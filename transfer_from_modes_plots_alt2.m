%
%  transfer_from_modes_plots_alt2.m  ver 1.1  by Tom Irvine
%
function[fig_num]=...
    transfer_from_modes_plots_alt2(iu,iam,i,k,fig_num,minf,maxf,H,freq,PPP,PHA)
%
    md=4;
...
%
    ...
    t_string=strrep(t_string,'Magnitude & Phase','');
