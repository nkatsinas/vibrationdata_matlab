...
%  aco_fds_plot_2x2_alt_h2.m  ver 1.1  by Tom Irvine

function[fig_num,h2]=aco_fds_plot_2x2_alt_h2(fig_num,Q,bex,fn,ff,xx,xfds,fds_ref,nmetric,iu)
...
[y_label,t_string]=aco_fds_ylabel(Q(i),bex(i),nmetric,iu);
