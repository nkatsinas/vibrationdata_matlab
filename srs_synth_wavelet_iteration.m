function varargout = srs_synth_wavelet_iteration(varargin)
% SRS_SYNTH_WAVELET_ITERATION MATLAB code for srs_synth_wavelet_iteration.fig
%      SRS_SYNTH_WAVELET_ITERATION, by itself, creates a new SRS_SYNTH_WAVELET_ITERATION or raises the existing
%      singleton*.
%
%      H = SRS_SYNTH_WAVELET_ITERATION returns the handle to a new SRS_SYNTH_WAVELET_ITERATION or the handle to
%      the existing singleton*.
%
%      SRS_SYNTH_WAVELET_ITERATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SRS_SYNTH_WAVELET_ITERATION.M with the given input arguments.
%
%      SRS_SYNTH_WAVELET_ITERATION('Property','Value',...) creates a new SRS_SYNTH_WAVELET_ITERATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before srs_synth_wavelet_iteration_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to srs_synth_wavelet_iteration_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help srs_synth_wavelet_iteration

% Last Modified by GUIDE v2.5 18-Apr-2022 12:25:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @srs_synth_wavelet_iteration_OpeningFcn, ...
                   'gui_OutputFcn',  @srs_synth_wavelet_iteration_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before srs_synth_wavelet_iteration is made visible.
function srs_synth_wavelet_iteration_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to srs_synth_wavelet_iteration (see VARARGIN)

% Choose default command line output for srs_synth_wavelet_iteration
...
% UIWAIT makes srs_synth_wavelet_iteration wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = srs_synth_wavelet_iteration_OutputFcn(hObject, eventdata, handles) 
...
thu=get(handles.edit_wavelet_table,'String');

if isempty(thu)
    warndlg('Time history does not exist');
    return;
else
    wavelet_table=evalin('base',thu);    
end

 temp=wavelet_table(:,2);
 wavelet_table(:,2)=wavelet_table(:,3);
 wavelet_table(:,3)=temp;
...
for i=1:last_wavelet
    ...
    td(i)=delay+wavelet_table_add(i,5);  
end
...
data1=acceleration;
data2=intermediate;
t_string1='Wavelet Decomposition';
t_string2='Intermediate';
...
[raccel,ramp,last_wavelet,f,amp,NHS,td,wavelet_low,wavelet_up,alpha,beta]=...
       quake_srs_synth_phase_3c(f,dt,amp,NHS,td,t,last_wavelet,...
...
function edit_wavelet_table_Callback(hObject, eventdata, handles)
% hObject    handle to edit_wavelet_table (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_wavelet_table as text
%        str2double(get(hObject,'String')) returns contents of edit_wavelet_table as a double


% --- Executes during object creation, after setting all properties.
function edit_wavelet_table_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_wavelet_table (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
