%
%  psd_envelope_function.m  ver 1.0   by Tom Irvine
%
...
function[env_psd,env_vrs]=...
    psd_envelope_function(input_psd,ntrials,npb,fmin,fmax,Q,plots,seed)
    ...
    %      
        ...
        [~,apsd_samfine]=env_interp_sam(f_sam,apsd_sam,nbreak,n_ref,f_ref);
        %                         
