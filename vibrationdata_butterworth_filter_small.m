function varargout = vibrationdata_butterworth_filter_small(varargin)
% VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL MATLAB code for vibrationdata_butterworth_filter_small.fig
%      VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL, by itself, creates a new VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL returns the handle to a new VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL.M with the given input arguments.
%
%      VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL('Property','Value',...) creates a new VIBRATIONDATA_BUTTERWORTH_FILTER_SMALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_butterworth_filter_small_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_butterworth_filter_small_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_butterworth_filter_small

% Last Modified by GUIDE v2.5 14-Jan-2020 16:49:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_butterworth_filter_small_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_butterworth_filter_small_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_butterworth_filter_small is made visible.
function vibrationdata_butterworth_filter_small_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_butterworth_filter_small (see VARARGIN)

% Choose default command line output for vibrationdata_butterworth_filter_small
...
% UIWAIT makes vibrationdata_butterworth_filter_small wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_butterworth_filter_small_OutputFcn(hObject, eventdata, handles) 
...
xlim([ xmin xmax ]);
    ...
    xx=110;
    yy=10;
    set(h3, 'Position', [200 200 200+xx 200+yy]);
    set(h4, 'Position', [200 200 200+xx 200+yy]);   
    set(h5, 'Position', [200 200 200+xx 200+yy]);   
