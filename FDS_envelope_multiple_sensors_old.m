function varargout = FDS_envelope_multiple_sensors_old(varargin)
% FDS_ENVELOPE_MULTIPLE_SENSORS_OLD MATLAB code for FDS_envelope_multiple_sensors_old.fig
%      FDS_ENVELOPE_MULTIPLE_SENSORS_OLD, by itself, creates a new FDS_ENVELOPE_MULTIPLE_SENSORS_OLD or raises the existing
%      singleton*.
%
%      H = FDS_ENVELOPE_MULTIPLE_SENSORS_OLD returns the handle to a new FDS_ENVELOPE_MULTIPLE_SENSORS_OLD or the handle to
%      the existing singleton*.
%
%      FDS_ENVELOPE_MULTIPLE_SENSORS_OLD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FDS_ENVELOPE_MULTIPLE_SENSORS_OLD.M with the given input arguments.
%
%      FDS_ENVELOPE_MULTIPLE_SENSORS_OLD('Property','Value',...) creates a new FDS_ENVELOPE_MULTIPLE_SENSORS_OLD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FDS_envelope_multiple_sensors_old_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FDS_envelope_multiple_sensors_old_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FDS_envelope_multiple_sensors_old

% Last Modified by GUIDE v2.5 03-May-2019 09:08:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FDS_envelope_multiple_sensors_old_OpeningFcn, ...
                   'gui_OutputFcn',  @FDS_envelope_multiple_sensors_old_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FDS_envelope_multiple_sensors_old is made visible.
function FDS_envelope_multiple_sensors_old_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FDS_envelope_multiple_sensors_old (see VARARGIN)

% Choose default command line output for FDS_envelope_multiple_sensors_old
...
% UIWAIT makes FDS_envelope_multiple_sensors_old wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FDS_envelope_multiple_sensors_old_OutputFcn(hObject, eventdata, handles) 
