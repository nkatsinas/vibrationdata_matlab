function varargout = beam_base_excitation_FEA(varargin)
% BEAM_BASE_EXCITATION_FEA MATLAB code for beam_base_excitation_FEA.fig
%      BEAM_BASE_EXCITATION_FEA, by itself, creates a new BEAM_BASE_EXCITATION_FEA or raises the existing
%      singleton*.
%
%      H = BEAM_BASE_EXCITATION_FEA returns the handle to a new BEAM_BASE_EXCITATION_FEA or the handle to
%      the existing singleton*.
%
%      BEAM_BASE_EXCITATION_FEA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BEAM_BASE_EXCITATION_FEA.M with the given input arguments.
%
%      BEAM_BASE_EXCITATION_FEA('Property','Value',...) creates a new BEAM_BASE_EXCITATION_FEA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before beam_base_excitation_FEA_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to beam_base_excitation_FEA_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help beam_base_excitation_FEA

% Last Modified by GUIDE v2.5 11-Nov-2022 17:46:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @beam_base_excitation_FEA_OpeningFcn, ...
                   'gui_OutputFcn',  @beam_base_excitation_FEA_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before beam_base_excitation_FEA is made visible.
function beam_base_excitation_FEA_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to beam_base_excitation_FEA (see VARARGIN)

% Choose default command line output for beam_base_excitation_FEA
...
% UIWAIT makes beam_base_excitation_FEA wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = beam_base_excitation_FEA_OutputFcn(hObject, eventdata, handles) 
...
[stiff,mass,stiff_unc,mass_unc,dof,dof_status,XL,ivector]=...
...
if(BC==1)
    fstr='beam_bending_base.jpg';
end
if(BC==2)
    fstr='beam_bending_base_ss.jpg';
end
if(BC==3)
    fstr='beam_bending_base_fixed.jpg';
end
...
delete(beam_base_excitation_FEA);
...
handles.s=beam_FEA_base_arbitrary;    
set(handles.s,'Visible','on'); 


% --- Executes during object creation, after setting all properties.
function pushbutton_arbitrary_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_arbitrary (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
