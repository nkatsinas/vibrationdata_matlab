...
%
%  update_shock_response_spectrum.m  ver 1.1  by Tom Irvine
%

function[cell_array]=update_shock_response_spectrum()
                ...
                if(contains(vars(i).name,'myHandle') || ...
                   ...
                   cell_array{i} ='999';
                    ...
                    try
                        ...
                        if(sz(2)==2 && mint2>=0.01 && maxt2>=0.5)
