function varargout = shock_distance_joints(varargin)
% SHOCK_DISTANCE_JOINTS MATLAB code for shock_distance_joints.fig
%      SHOCK_DISTANCE_JOINTS, by itself, creates a new SHOCK_DISTANCE_JOINTS or raises the existing
%      singleton*.
%
%      H = SHOCK_DISTANCE_JOINTS returns the handle to a new SHOCK_DISTANCE_JOINTS or the handle to
%      the existing singleton*.
%
%      SHOCK_DISTANCE_JOINTS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SHOCK_DISTANCE_JOINTS.M with the given input arguments.
%
%      SHOCK_DISTANCE_JOINTS('Property','Value',...) creates a new SHOCK_DISTANCE_JOINTS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before shock_distance_joints_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to shock_distance_joints_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help shock_distance_joints

% Last Modified by GUIDE v2.5 11-Feb-2020 12:13:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @shock_distance_joints_OpeningFcn, ...
                   'gui_OutputFcn',  @shock_distance_joints_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before shock_distance_joints is made visible.
function shock_distance_joints_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to shock_distance_joints (see VARARGIN)

% Choose default command line output for shock_distance_joints
...
% UIWAIT makes shock_distance_joints wait for user response (see UIRESUME)
...
function varargout = shock_distance_joints_OutputFcn(hObject, eventdata, handles) 
