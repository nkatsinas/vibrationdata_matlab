function varargout = two_dof_system_a_force(varargin)
% TWO_DOF_SYSTEM_A_FORCE MATLAB code for two_dof_system_a_force.fig
%      TWO_DOF_SYSTEM_A_FORCE, by itself, creates a new TWO_DOF_SYSTEM_A_FORCE or raises the existing
%      singleton*.
%
%      H = TWO_DOF_SYSTEM_A_FORCE returns the handle to a new TWO_DOF_SYSTEM_A_FORCE or the handle to
%      the existing singleton*.
%
%      TWO_DOF_SYSTEM_A_FORCE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TWO_DOF_SYSTEM_A_FORCE.M with the given input arguments.
%
%      TWO_DOF_SYSTEM_A_FORCE('Property','Value',...) creates a new TWO_DOF_SYSTEM_A_FORCE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before two_dof_system_a_force_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to two_dof_system_a_force_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help two_dof_system_a_force

% Last Modified by GUIDE v2.5 07-Aug-2017 13:30:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @two_dof_system_a_force_OpeningFcn, ...
                   'gui_OutputFcn',  @two_dof_system_a_force_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before two_dof_system_a_force is made visible.
function two_dof_system_a_force_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to two_dof_system_a_force (see VARARGIN)

% Choose default command line output for two_dof_system_a_force
...
% UIWAIT makes two_dof_system_a_force wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = two_dof_system_a_force_OutputFcn(hObject, eventdata, handles) 
...
set(handles.pushbutton_cforce,'Visible','off');
%
...
set(handles.pushbutton_cforce,'Visible','on');
...
% --- Executes on button press in pushbutton_cforce.
function pushbutton_cforce_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_cforce (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

handles.s= vibrationdata_two_dof_constant_force_semidefinite;
set(handles.s,'Visible','on');
