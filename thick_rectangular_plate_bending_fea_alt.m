function varargout = thick_rectangular_plate_bending_fea_alt(varargin)
% THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT MATLAB code for thick_rectangular_plate_bending_fea_alt.fig
%      THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT, by itself, creates a new THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT or raises the existing
%      singleton*.
%
%      H = THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT returns the handle to a new THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT or the handle to
%      the existing singleton*.
%
%      THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT.M with the given input arguments.
%
%      THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT('Property','Value',...) creates a new THICK_RECTANGULAR_PLATE_BENDING_FEA_ALT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before thick_rectangular_plate_bending_fea_alt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to thick_rectangular_plate_bending_fea_alt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help thick_rectangular_plate_bending_fea_alt

% Last Modified by GUIDE v2.5 26-Jul-2022 19:28:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @thick_rectangular_plate_bending_fea_alt_OpeningFcn, ...
                   'gui_OutputFcn',  @thick_rectangular_plate_bending_fea_alt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before thick_rectangular_plate_bending_fea_alt is made visible.
function thick_rectangular_plate_bending_fea_alt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to thick_rectangular_plate_bending_fea_alt (see VARARGIN)

% Choose default command line output for thick_rectangular_plate_bending_fea_alt
...
function varargout = thick_rectangular_plate_bending_fea_alt_OutputFcn(hObject, eventdata, handles) 
...
unitlistbox_Callback(hObject, eventdata, handles);
...
%  https://www.mathworks.com/matlabcentral/answers/1669299-simulation-of-a-time-depending-plate-vibration
%  https://www.mathworks.com/help/pde/ug/stress-concentration-in-plate-with-circular-hole.html
%  https://lost-contact.mit.edu/afs/inf.ed.ac.uk/group/teaching/matlab-help/R2018a/help/pde/ug/pde.pdemodel.geometryfromedges.html
