function varargout = vibrationdata_plot_time_history_small(varargin)
% VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL MATLAB code for vibrationdata_plot_time_history_small.fig
%      VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL, by itself, creates a new VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL returns the handle to a new VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL.M with the given input arguments.
%
%      VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL('Property','Value',...) creates a new VIBRATIONDATA_PLOT_TIME_HISTORY_SMALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_plot_time_history_small_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_plot_time_history_small_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_plot_time_history_small

% Last Modified by GUIDE v2.5 14-Jan-2020 12:15:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_plot_time_history_small_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_plot_time_history_small_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_plot_time_history_small is made visible.
function vibrationdata_plot_time_history_small_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_plot_time_history_small (see VARARGIN)

% Choose default command line output for vibrationdata_plot_time_history_small
...
% UIWAIT makes vibrationdata_plot_time_history_small wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_plot_time_history_small_OutputFcn(hObject, eventdata, handles) 
...
title_label=strrep(title_label,'_',' ');
...
try
    ...
    xx=110;
    yy=10;
    set(hp, 'Position', [200 200 200+xx 200+yy]);
