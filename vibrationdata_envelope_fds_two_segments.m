function varargout = vibrationdata_envelope_fds_two_segments(varargin)
% VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS MATLAB code for vibrationdata_envelope_fds_two_segments.fig
%      VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS, by itself, creates a new VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS returns the handle to a new VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS.M with the given input arguments.
%
%      VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS('Property','Value',...) creates a new VIBRATIONDATA_ENVELOPE_FDS_TWO_SEGMENTS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_envelope_fds_two_segments_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_envelope_fds_two_segments_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_envelope_fds_two_segments

% Last Modified by GUIDE v2.5 15-Mar-2019 15:24:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_envelope_fds_two_segments_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_envelope_fds_two_segments_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_envelope_fds_two_segments is made visible.
function vibrationdata_envelope_fds_two_segments_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_envelope_fds_two_segments (see VARARGIN)

% Choose default command line output for vibrationdata_envelope_fds_two_segments
...
% UIWAIT makes vibrationdata_envelope_fds_two_segments wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_envelope_fds_two_segments_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_envelope_fds_two_segments);
...
tstart(1)=str2num(get(handles.edit_s1_start,'String'));
tend(1)=str2num(get(handles.edit_s1_end,'String'));

tstart(2)=str2num(get(handles.edit_s2_start,'String'));
tend(2)=str2num(get(handles.edit_s2_end,'String'));
...
for ijk=1:2
    ...
    [~,i1] = min(abs(t-tstart(ijk)));
    [~,i2] = min(abs(t-tend(ijk)));
    
    base=double(THM(i1:i2,2));
...
%
        if(num_eng==1)
            [fds_s]=env_fds_th_direct(base,dt,fn,damp,bex,iu,nmetric);        
        else
            [fds_s]=env_fds_th2(base,dt,fn,damp,bex,iu,nmetric);
        end    
%    
    else          % sine
%    
        [fds_s]=env_fds_th_sine(base,dt,fn,damp,bex,iu,nmetric);       
%
    end    
    ...
    for i=1:n_damp
        for j=1:n_bex
            for k=1:n_ref
                fds_ref(i,j,k)=fds_ref(i,j,k)+fds_s(i,j,k);
            end
        end
    end
...
%
        ...
        sbex=strrep(sbex, '.', 'p');
        output_name=strtrim(sprintf('%s_psd_fds_Q%g_b%s',FS,Q(i),sbex));
...
%%%%%%%%%%%
%       
        output_name_ref=strtrim(sprintf('%s_time_history_fds_Q%g_b%s',FS,Q(i),sbex));
...
function edit_s1_start_Callback(hObject, eventdata, handles)
% hObject    handle to edit_s1_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_s1_start as text
%        str2double(get(hObject,'String')) returns contents of edit_s1_start as a double


% --- Executes during object creation, after setting all properties.
function edit_s1_start_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_s1_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_s1_end_Callback(hObject, eventdata, handles)
% hObject    handle to edit_s1_end (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_s1_end as text
%        str2double(get(hObject,'String')) returns contents of edit_s1_end as a double


% --- Executes during object creation, after setting all properties.
function edit_s1_end_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_s1_end (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_s2_start_Callback(hObject, eventdata, handles)
% hObject    handle to edit_s2_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_s2_start as text
%        str2double(get(hObject,'String')) returns contents of edit_s2_start as a double


% --- Executes during object creation, after setting all properties.
function edit_s2_start_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_s2_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_s2_end_Callback(hObject, eventdata, handles)
% hObject    handle to edit_s2_end (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_s2_end as text
%        str2double(get(hObject,'String')) returns contents of edit_s2_end as a double


% --- Executes during object creation, after setting all properties.
function edit_s2_end_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_s2_end (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
