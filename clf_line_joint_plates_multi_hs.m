function varargout = clf_line_joint_plates_multi_hs(varargin)
% CLF_LINE_JOINT_PLATES_MULTI_HS MATLAB code for clf_line_joint_plates_multi_hs.fig
%      CLF_LINE_JOINT_PLATES_MULTI_HS, by itself, creates a new CLF_LINE_JOINT_PLATES_MULTI_HS or raises the existing
%      singleton*.
%
%      H = CLF_LINE_JOINT_PLATES_MULTI_HS returns the handle to a new CLF_LINE_JOINT_PLATES_MULTI_HS or the handle to
%      the existing singleton*.
%
%      CLF_LINE_JOINT_PLATES_MULTI_HS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CLF_LINE_JOINT_PLATES_MULTI_HS.M with the given input arguments.
%
%      CLF_LINE_JOINT_PLATES_MULTI_HS('Property','Value',...) creates a new CLF_LINE_JOINT_PLATES_MULTI_HS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before clf_line_joint_plates_multi_hs_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to clf_line_joint_plates_multi_hs_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help clf_line_joint_plates_multi_hs

% Last Modified by GUIDE v2.5 14-Nov-2017 17:45:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @clf_line_joint_plates_multi_hs_OpeningFcn, ...
                   'gui_OutputFcn',  @clf_line_joint_plates_multi_hs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before clf_line_joint_plates_multi_hs is made visible.
function clf_line_joint_plates_multi_hs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to clf_line_joint_plates_multi_hs (see VARARGIN)

% Choose default command line output for clf_line_joint_plates_multi_hs
...
% UIWAIT makes clf_line_joint_plates_multi_hs wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = clf_line_joint_plates_multi_hs_OutputFcn(hObject, eventdata, handles) 
...
delete(clf_line_joint_plates_multi_hs);
...
for i=1:NL
    ...
    [clf12(i),clf21(i),~]=sandwich_panel_line(omega,B,Bf,G,mpa,hc,Lc,A1,A2);    
