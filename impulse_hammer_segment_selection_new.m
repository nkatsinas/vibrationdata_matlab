function varargout = impulse_hammer_segment_selection_new(varargin)
% IMPULSE_HAMMER_SEGMENT_SELECTION_NEW MATLAB code for impulse_hammer_segment_selection_new.fig
%      IMPULSE_HAMMER_SEGMENT_SELECTION_NEW, by itself, creates a new IMPULSE_HAMMER_SEGMENT_SELECTION_NEW or raises the existing
%      singleton*.
%
%      H = IMPULSE_HAMMER_SEGMENT_SELECTION_NEW returns the handle to a new IMPULSE_HAMMER_SEGMENT_SELECTION_NEW or the handle to
%      the existing singleton*.
%
%      IMPULSE_HAMMER_SEGMENT_SELECTION_NEW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPULSE_HAMMER_SEGMENT_SELECTION_NEW.M with the given input arguments.
%
%      IMPULSE_HAMMER_SEGMENT_SELECTION_NEW('Property','Value',...) creates a new IMPULSE_HAMMER_SEGMENT_SELECTION_NEW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before impulse_hammer_segment_selection_new_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to impulse_hammer_segment_selection_new_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help impulse_hammer_segment_selection_new

% Last Modified by GUIDE v2.5 01-May-2021 09:13:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @impulse_hammer_segment_selection_new_OpeningFcn, ...
                   'gui_OutputFcn',  @impulse_hammer_segment_selection_new_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before impulse_hammer_segment_selection_new is made visible.
function impulse_hammer_segment_selection_new_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to impulse_hammer_segment_selection_new (see VARARGIN)

% Choose default command line output for impulse_hammer_segment_selection_new
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes impulse_hammer_segment_selection_new wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = impulse_hammer_segment_selection_new_OutputFcn(hObject, eventdata, handles) 
