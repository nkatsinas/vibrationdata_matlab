function varargout = SEA_equivalent_acoustic_power_baffled_sandwich_multi(varargin)
% SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI MATLAB code for SEA_equivalent_acoustic_power_baffled_sandwich_multi.fig
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI, by itself, creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI or raises the existing
%      singleton*.
%
%      H = SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI returns the handle to a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI or the handle to
%      the existing singleton*.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI.M with the given input arguments.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI('Property','Value',...) creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH_MULTI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equivalent_acoustic_power_baffled_sandwich_multi_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equivalent_acoustic_power_baffled_sandwich_multi_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equivalent_acoustic_power_baffled_sandwich_multi

% Last Modified by GUIDE v2.5 28-Apr-2016 09:57:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equivalent_acoustic_power_baffled_sandwich_multi_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equivalent_acoustic_power_baffled_sandwich_multi_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equivalent_acoustic_power_baffled_sandwich_multi is made visible.
function SEA_equivalent_acoustic_power_baffled_sandwich_multi_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equivalent_acoustic_power_baffled_sandwich_multi (see VARARGIN)

% Choose default command line output for SEA_equivalent_acoustic_power_baffled_sandwich_multi
...
% UIWAIT makes SEA_equivalent_acoustic_power_baffled_sandwich_multi wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equivalent_acoustic_power_baffled_sandwich_multi_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equivalent_acoustic_power_panel_sandwich_multi);
...
for i=1:NL
    ...
    radiation_resistance(i)=rho_c*Ap*rad_eff_half_space(i); 

    fsep=1/mph(i);

    num=c^2*rad_eff_half_space(i)*pressure(i)^2;
...
t_string='Honeycomb Sandwich Panel Modal Density'; 
...
t_string='Honeycomb Sandwich Panel Radiation Efficiency'; 
...
A = imread('equivalent_acoustic_power_sandwich.jpg');
figure(999) 
imshow(A,'border','tight','InitialMagnification',100);
