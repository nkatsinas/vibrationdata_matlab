function varargout = SOR_vrs(varargin)
% SOR_VRS MATLAB code for SOR_vrs.fig
%      SOR_VRS, by itself, creates a new SOR_VRS or raises the existing
%      singleton*.
%
%      H = SOR_VRS returns the handle to a new SOR_VRS or the handle to
%      the existing singleton*.
%
%      SOR_VRS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOR_VRS.M with the given input arguments.
%
%      SOR_VRS('Property','Value',...) creates a new SOR_VRS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SOR_vrs_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SOR_vrs_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SOR_vrs

% Last Modified by GUIDE v2.5 10-Nov-2020 16:36:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SOR_vrs_OpeningFcn, ...
                   'gui_OutputFcn',  @SOR_vrs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SOR_vrs is made visible.
function SOR_vrs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SOR_vrs (see VARARGIN)

% Choose default command line output for SOR_vrs
...
% UIWAIT makes SOR_vrs wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SOR_vrs_OutputFcn(hObject, eventdata, handles) 
