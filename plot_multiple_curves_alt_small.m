function varargout = plot_multiple_curves_alt_small(varargin)
% PLOT_MULTIPLE_CURVES_ALT_SMALL MATLAB code for plot_multiple_curves_alt_small.fig
%      PLOT_MULTIPLE_CURVES_ALT_SMALL, by itself, creates a new PLOT_MULTIPLE_CURVES_ALT_SMALL or raises the existing
%      singleton*.
%
%      H = PLOT_MULTIPLE_CURVES_ALT_SMALL returns the handle to a new PLOT_MULTIPLE_CURVES_ALT_SMALL or the handle to
%      the existing singleton*.
%
%      PLOT_MULTIPLE_CURVES_ALT_SMALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLOT_MULTIPLE_CURVES_ALT_SMALL.M with the given input arguments.
%
%      PLOT_MULTIPLE_CURVES_ALT_SMALL('Property','Value',...) creates a new PLOT_MULTIPLE_CURVES_ALT_SMALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before plot_multiple_curves_alt_small_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to plot_multiple_curves_alt_small_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help plot_multiple_curves_alt_small

% Last Modified by GUIDE v2.5 14-Jan-2020 15:25:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @plot_multiple_curves_alt_small_OpeningFcn, ...
                   'gui_OutputFcn',  @plot_multiple_curves_alt_small_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before plot_multiple_curves_alt_small is made visible.
function plot_multiple_curves_alt_small_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to plot_multiple_curves_alt_small (see VARARGIN)

% Choose default command line output for plot_multiple_curves_alt_small
...
% UIWAIT makes plot_multiple_curves_alt_small wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = plot_multiple_curves_alt_small_OutputFcn(hObject, eventdata, handles) 
