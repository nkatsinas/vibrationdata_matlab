function varargout = vibrationdata_wavelet_synth_ierror(varargin)
% VIBRATIONDATA_WAVELET_SYNTH_IERROR MATLAB code for vibrationdata_wavelet_synth_ierror.fig
%      VIBRATIONDATA_WAVELET_SYNTH_IERROR, by itself, creates a new VIBRATIONDATA_WAVELET_SYNTH_IERROR or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_WAVELET_SYNTH_IERROR returns the handle to a new VIBRATIONDATA_WAVELET_SYNTH_IERROR or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_WAVELET_SYNTH_IERROR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_WAVELET_SYNTH_IERROR.M with the given input arguments.
%
%      VIBRATIONDATA_WAVELET_SYNTH_IERROR('Property','Value',...) creates a new VIBRATIONDATA_WAVELET_SYNTH_IERROR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_wavelet_synth_ierror_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_wavelet_synth_ierror_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_wavelet_synth_ierror

% Last Modified by GUIDE v2.5 16-Apr-2022 20:39:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_wavelet_synth_ierror_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_wavelet_synth_ierror_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_wavelet_synth_ierror is made visible.
function vibrationdata_wavelet_synth_ierror_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_wavelet_synth_ierror (see VARARGIN)

% Choose default command line output for vibrationdata_wavelet_synth_ierror
...
% UIWAIT makes vibrationdata_wavelet_synth_ierror wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_wavelet_synth_ierror_OutputFcn(hObject, eventdata, handles) 
...
%                    
            ...
            if(irror<ierror_max)
                ierror_max=irror;
                    ...
                    out1=sprintf('SRS Q=10   %8.3g dB',20*ierror_max);
                    title(out1);
            end
