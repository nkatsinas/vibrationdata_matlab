...
% BeamTransCore.m  ver 1.0 by Tom Irvine


function[HM_accel_left,HM_accel_mid,HM_accel_right,HM_rd_left,HM_rd_mid,HM_rd_right,adisp]=...
                BeamTransCore(nff,np,num,nem,dm,pMST,num_columns,pomn2,om2,pomegan,...
                omega,TT,pdof,Mwd,pModeShapes,ngw,mid_dof)
