function varargout = SEA_equivalent_acoustic_power_baffled_sandwich(varargin)
% SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH MATLAB code for SEA_equivalent_acoustic_power_baffled_sandwich.fig
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH, by itself, creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH or raises the existing
%      singleton*.
%
%      H = SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH returns the handle to a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH or the handle to
%      the existing singleton*.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH.M with the given input arguments.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH('Property','Value',...) creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_BAFFLED_SANDWICH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equivalent_acoustic_power_baffled_sandwich_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equivalent_acoustic_power_baffled_sandwich_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equivalent_acoustic_power_baffled_sandwich

% Last Modified by GUIDE v2.5 27-Apr-2016 12:44:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equivalent_acoustic_power_baffled_sandwich_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equivalent_acoustic_power_baffled_sandwich_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equivalent_acoustic_power_baffled_sandwich is made visible.
function SEA_equivalent_acoustic_power_baffled_sandwich_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equivalent_acoustic_power_baffled_sandwich (see VARARGIN)

% Choose default command line output for SEA_equivalent_acoustic_power_baffled_sandwich
...
% UIWAIT makes SEA_equivalent_acoustic_power_baffled_sandwich wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equivalent_acoustic_power_baffled_sandwich_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equivalent_acoustic_power_panel_sandwich);
...
Sfreq = get(handles.edit_freq, 'String');
if isempty(Sfreq)
...
omega=tpi*freq;
[mph]=Renji_modal_density(omega,Ap,S,B,mpa);
 

[rad_eff_half_space]=rad_eff_sandwich_panel_function(freq,c,B,Bf,G,mpa,hc);
...
num=c^2*rad_eff_half_space*pressure^2;
...
out1=sprintf('            Frequency = %8.4g Hz',freq);
out2=sprintf(' Radiation Efficiency = %8.4g',rad_eff_half_space);

if(iu==1)
    out3=sprintf(' Radiation Resistance = %8.4g lbf sec/in',radiation_resistance);
else   
    out3=sprintf(' Radiation Resistance = %8.4g N sec/m',radiation_resistance);       
end

  out4=sprintf('\n        Modal Density = %8.4g modes/Hz',mph);
