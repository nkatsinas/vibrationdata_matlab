...
function[omegan,fbig,part,phi,phi_x,phi_xx,phi_y,phi_yy,phi_xy,fig_num]=fixed_fixed_fixed_fixed_Rayleigh_alt(AAA,Amn,DD,a,b,nm,fig_num)
...
%%%%%%%%%
    ...
    part=@(AAA,m,n)1;   
       ...
       phi=@(P,W,beta_x,beta_y,sigma)(P(x)*W(y));   
       
     phi_x=@(Amn,x,y,m,n,a,b)(1);       
    phi_xx=@(Amn,x,y,m,n,a,b)(1); 
    
     phi_y=@(Amn,x,y,m,n,a,b)(1);  
    phi_yy=@(Amn,x,y,m,n,a,b)(1);     

    phi_xy=@(Amn,x,y,m,n,a,b)(1);    
...
for i=1:num 
    for j=1:num 
        zzr(i,j)=phi(P,W,beta_x,beta_y,sigma);  
    end
end
