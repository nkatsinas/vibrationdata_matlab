%
%  fixed_fixed_fixed_fixed_plate_Rayleigh_alta.m  ver 1.2  by Tom Irvine
%
function[fn,zzr,fig_num,P,dPdx,d2Pdx2,W,dWdy,d2Wdy2,norm,PF]=...
fixed_fixed_fixed_fixed_plate_Rayleigh_alta(D,rho,h,a,b,mu,mass_per_area,fig_num,iu)
%
clear x;
clear y;
%
