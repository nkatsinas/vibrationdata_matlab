%
%  generic_psd_syn_function.m  ver 1.0  by Tom Irvine
%
%  This script synthesizes a time history to satisfy a generic psd
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  Input variables:
%
%   duration = sec
%        psd = two column array:  freq(Hz) & amplitude(unit^2/Hz)
...
%  Output array:
%
%     psd_synthesis = two column array:  Time(sec) & amplitude(unit)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  External arrays:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
function[psd_synthesis]=generic_psd_syn_function(duration,psd,sr)
