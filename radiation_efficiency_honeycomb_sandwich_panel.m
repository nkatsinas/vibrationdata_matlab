function varargout = radiation_efficiency_honeycomb_sandwich_panel(varargin)
% RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL MATLAB code for radiation_efficiency_honeycomb_sandwich_panel.fig
%      RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL, by itself, creates a new RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL or raises the existing
%      singleton*.
%
%      H = RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL returns the handle to a new RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL or the handle to
%      the existing singleton*.
%
%      RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL.M with the given input arguments.
%
%      RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL('Property','Value',...) creates a new RADIATION_EFFICIENCY_HONEYCOMB_SANDWICH_PANEL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before radiation_efficiency_honeycomb_sandwich_panel_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to radiation_efficiency_honeycomb_sandwich_panel_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help radiation_efficiency_honeycomb_sandwich_panel

% Last Modified by GUIDE v2.5 10-May-2016 19:09:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @radiation_efficiency_honeycomb_sandwich_panel_OpeningFcn, ...
                   'gui_OutputFcn',  @radiation_efficiency_honeycomb_sandwich_panel_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before radiation_efficiency_honeycomb_sandwich_panel is made visible.
function radiation_efficiency_honeycomb_sandwich_panel_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to radiation_efficiency_honeycomb_sandwich_panel (see VARARGIN)

% Choose default command line output for radiation_efficiency_honeycomb_sandwich_panel
...
% UIWAIT makes radiation_efficiency_honeycomb_sandwich_panel wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = radiation_efficiency_honeycomb_sandwich_panel_OutputFcn(hObject, eventdata, handles) 
