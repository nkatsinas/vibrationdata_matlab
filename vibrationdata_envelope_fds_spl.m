function varargout = vibrationdata_envelope_fds_spl(varargin)
% VIBRATIONDATA_ENVELOPE_FDS_SPL MATLAB code for vibrationdata_envelope_fds_spl.fig
%      VIBRATIONDATA_ENVELOPE_FDS_SPL, by itself, creates a new VIBRATIONDATA_ENVELOPE_FDS_SPL or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_ENVELOPE_FDS_SPL returns the handle to a new VIBRATIONDATA_ENVELOPE_FDS_SPL or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_ENVELOPE_FDS_SPL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_ENVELOPE_FDS_SPL.M with the given input arguments.
%
%      VIBRATIONDATA_ENVELOPE_FDS_SPL('Property','Value',...) creates a new VIBRATIONDATA_ENVELOPE_FDS_SPL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_envelope_fds_spl_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_envelope_fds_spl_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_envelope_fds_spl

% Last Modified by GUIDE v2.5 21-Aug-2019 09:32:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_envelope_fds_spl_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_envelope_fds_spl_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_envelope_fds_spl is made visible.
function vibrationdata_envelope_fds_spl_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_envelope_fds_spl (see VARARGIN)

% Choose default command line output for vibrationdata_envelope_fds_spl
...
% UIWAIT makes vibrationdata_envelope_fds_spl wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_envelope_fds_spl_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_envelope_fds_spl);
...
%	   
            ...
            [f_sam,apsd_sam]=...
                env_generate_sample_psd_spl(n_ref,nbreak,npb,fn,ik,slopec,initial,final,f1,f2,fc);            
%
    else
%
			[f_sam,apsd_sam]=...
                env_generate_sample_psd2_spl(n_ref,nbreak,npb,fn,xf,xapsd,slopec,initial,final,ik,f1,f2,fc);
%
    end
...
power_spectral_density=getappdata(0,'power_spectral_density');
...
[SPL]=psd_spl_function(ref,fi,ai,fl,fc,fu,df);
