function varargout = SEA_equivalent_acoustic_power_panel_sandwich(varargin)
% SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH MATLAB code for SEA_equivalent_acoustic_power_panel_sandwich.fig
%      SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH, by itself, creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH or raises the existing
%      singleton*.
%
%      H = SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH returns the handle to a new SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH or the handle to
%      the existing singleton*.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH.M with the given input arguments.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH('Property','Value',...) creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_PANEL_SANDWICH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equivalent_acoustic_power_panel_sandwich_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equivalent_acoustic_power_panel_sandwich_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equivalent_acoustic_power_panel_sandwich

% Last Modified by GUIDE v2.5 30-Jan-2016 10:02:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equivalent_acoustic_power_panel_sandwich_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equivalent_acoustic_power_panel_sandwich_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equivalent_acoustic_power_panel_sandwich is made visible.
function SEA_equivalent_acoustic_power_panel_sandwich_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equivalent_acoustic_power_panel_sandwich (see VARARGIN)

% Choose default command line output for SEA_equivalent_acoustic_power_panel_sandwich
...
% UIWAIT makes SEA_equivalent_acoustic_power_panel_sandwich wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equivalent_acoustic_power_panel_sandwich_OutputFcn(hObject, eventdata, handles) 
...
disp(' * * * ');
disp('  ');
%% disp(' Reference: Conlon paper via Wijker book ');
%% disp('  ');
...
[rad_eff_half_space]=rad_eff_sandwich_panel_function(f,c,B,Bf,G,mpa,hc);
...
for i=1:NL
   out1=sprintf(' %8.4g %8.4g %8.4g ',f(i),rad_eff_half_space(i),radiation_resistance(i));
   disp(out1); 
end  
...
t_string='Sandwich Panel Radiation Efficiency';       

ppp=[f real(rad_eff_half_space)];
rad_eff_half_space=ppp;
...
t_string='Sandwich Panel Radiation Resistance';
...
disp(' ');
disp(' Output arrays saved to:  rad_eff_half_space & radiation_resistance ');

assignin('base', 'rad_eff_half_space', rad_eff_half_space);  
