%
%  psd_envelope_vrs_fds.m  ver 1.0   by Tom Irvine
%
...
%   6  five arbitrary
%   7  five ramp-plateau-ramp-plateau
...
%   Output Data
%
%       env_psd = envelope psd - freq (Hz) & accel (G^2/Hz)
%       env_vrs = envelope vrs - natural frequency (Hz) & GRMS
%
%   fds has multiple columns:
%       natural frequency (Hz)
%       and relative damage (accel unit)^b for each Q and b combination 
%       with Q=10 & 30  and  b=4 & 8
%
%    T = duration (sec) 
%
...
%       ymax_ymin_md
%       smooth_psd_function
%       fds_sdof_response_Dirlik_damage
%       
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%

function[env_psd,env_vrs,env_fds]=...
    psd_envelope_vrs_fds_function(input_psd,ntrials,npb,Q,plots,seed,T,ispace)
    ...
    %      
        ...
        % Generate the sample psd
            ...
            [f_sam,apsd_sam,~,slopec]=...
                 env_generate_sample_psd_via_vrs(n_ref,nbreak,npb,f_ref,...
                                     slopec,initial,final,f1,f2,FL,FU,nfc);
        %          
        else
        %         
    ...
    QQ=[10 30];
    b=[4 8];
    [env_fds]=fds_sdof_response_Dirlik_damage_alt(best_psd,QQ,b,T,ispace,plots);
