function varargout = multiple_fds_one_event(varargin)
% MULTIPLE_FDS_ONE_EVENT MATLAB code for multiple_fds_one_event.fig
%      MULTIPLE_FDS_ONE_EVENT, by itself, creates a new MULTIPLE_FDS_ONE_EVENT or raises the existing
%      singleton*.
%
%      H = MULTIPLE_FDS_ONE_EVENT returns the handle to a new MULTIPLE_FDS_ONE_EVENT or the handle to
%      the existing singleton*.
%
%      MULTIPLE_FDS_ONE_EVENT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MULTIPLE_FDS_ONE_EVENT.M with the given input arguments.
%
%      MULTIPLE_FDS_ONE_EVENT('Property','Value',...) creates a new MULTIPLE_FDS_ONE_EVENT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before multiple_fds_one_event_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to multiple_fds_one_event_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help multiple_fds_one_event

% Last Modified by GUIDE v2.5 04-Oct-2019 17:04:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @multiple_fds_one_event_OpeningFcn, ...
                   'gui_OutputFcn',  @multiple_fds_one_event_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before multiple_fds_one_event is made visible.
function multiple_fds_one_event_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to multiple_fds_one_event (see VARARGIN)

% Choose default command line output for multiple_fds_one_event
...
% UIWAIT makes multiple_fds_one_event wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = multiple_fds_one_event_OutputFcn(hObject, eventdata, handles) 
...
cn={'Time History','Legend','Start Time 1','Start Time 2'};
