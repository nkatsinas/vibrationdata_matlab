function varargout = add_margin_srs(varargin)
% ADD_MARGIN_SRS MATLAB code for add_margin_srs.fig
%      ADD_MARGIN_SRS, by itself, creates a new ADD_MARGIN_SRS or raises the existing
%      singleton*.
%
%      H = ADD_MARGIN_SRS returns the handle to a new ADD_MARGIN_SRS or the handle to
%      the existing singleton*.
%
%      ADD_MARGIN_SRS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ADD_MARGIN_SRS.M with the given input arguments.
%
%      ADD_MARGIN_SRS('Property','Value',...) creates a new ADD_MARGIN_SRS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before add_margin_srs_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to add_margin_srs_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help add_margin_srs

% Last Modified by GUIDE v2.5 02-May-2019 16:08:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @add_margin_srs_OpeningFcn, ...
                   'gui_OutputFcn',  @add_margin_srs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before add_margin_srs is made visible.
function add_margin_srs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to add_margin_srs (see VARARGIN)

% Choose default command line output for add_margin_srs
handles.output = hObject;



set(handles.listbox_type,'Value',2,'Visible','off');
...
% UIWAIT makes add_margin_srs wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = add_margin_srs_OutputFcn(hObject, eventdata, handles) 
...
for i=1:sz(1)
    out1=sprintf(' %9.0f \t %9.0f ',ppp2(i,1),ppp2(i,2));
    disp(out1); 
end
disp(' ');
