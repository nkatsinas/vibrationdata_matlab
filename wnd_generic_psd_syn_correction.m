%
%  wnd_generic_psd_syn_correction.m  ver 1.2   by Tom Irvine
%
function[amp,freq,full,tim,df]=...
      wnd_generic_psd_syn_correction(nnt,amp,dt,spec_grms,NW,freq_spec,...
...
%
        amp=amp+0.7*ca*sin(tpi*fff*tim+pha);
%
    end
%
end
...
npe=0.25;
[amp]=half_cosine_fade_perc(amp,npe);
