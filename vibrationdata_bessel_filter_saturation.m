function varargout = vibrationdata_bessel_filter_saturation(varargin)
% VIBRATIONDATA_BESSEL_FILTER_SATURATION MATLAB code for vibrationdata_bessel_filter_saturation.fig
%      VIBRATIONDATA_BESSEL_FILTER_SATURATION, by itself, creates a new VIBRATIONDATA_BESSEL_FILTER_SATURATION or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_BESSEL_FILTER_SATURATION returns the handle to a new VIBRATIONDATA_BESSEL_FILTER_SATURATION or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_BESSEL_FILTER_SATURATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_BESSEL_FILTER_SATURATION.M with the given input arguments.
%
%      VIBRATIONDATA_BESSEL_FILTER_SATURATION('Property','Value',...) creates a new VIBRATIONDATA_BESSEL_FILTER_SATURATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_bessel_filter_saturation_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_bessel_filter_saturation_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_bessel_filter_saturation

% Last Modified by GUIDE v2.5 26-Jun-2019 16:27:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_bessel_filter_saturation_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_bessel_filter_saturation_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_bessel_filter_saturation is made visible.
function vibrationdata_bessel_filter_saturation_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_bessel_filter_saturation (see VARARGIN)

% Choose default command line output for vibrationdata_bessel_filter_saturation
...
% UIWAIT makes vibrationdata_bessel_filter_saturation wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vibrationdata_bessel_filter_saturation_OutputFcn(hObject, eventdata, handles) 
...
delete(vibrationdata_bessel_filter_saturation);
...
%    
    ...
    fc1=fc(i);
    [yf]=bessel_filter_core(fc1,dt,a);
    b=a-yf;
